...
void MainWindow::on_pushButton_proc_clicked()
{
    ...
    double result = qPow(variableCalc, 2);
...
void MainWindow::on_pushButton_ln_clicked()
{
    ...
    double result = qLn(operand);

    if (result == INFINITY)
            result = operand;


    qDebug() << lastNumber.count();
